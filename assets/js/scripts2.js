...
(function () {
    ...
    let meshAttributes = {
        ...
        camera_m3: {
            src: "/assets/glb/man_camera_m3.glb",
            poster: "/assets/poster/man_camera_m3.png",
            "environment-image": "https://modelviewer.dev/shared-assets/environments/lightroom_14b.hdr",
            caption: "man camera m3",
            shortCaption: "man camera m3"
        },
        old_man_m0: {
    ...
    let meshRows = [
        ...
        ['camera_m0', 'camera_m1', 'camera_m2', 'camera_m3'],
        ['old_man_m0', 'old_man_m1', 'old_man_m2', 'old_man_m3'],
        ['shield_m0','shield_m1', 'shield_m2', 'shield_m3'],
        ['archer_m0', 'archer_m1', 'archer_m2', 'archer_m3'],
        ['wooden_car_m0', 'wooden_car_m1', 'wooden_car_m2', 'wooden_car_m3',]
    ];
